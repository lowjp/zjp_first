...
const pages = [
  ...
  {
    path: "uni_modules/uni-id-pages/components/uni-id-pages-avatar/uni-id-pages-avatar",
    style: {
...
let w;
w = m;
const v = p('{\n    "address": [\n        "127.0.0.1",\n        "192.168.56.1",\n        "192.168.43.114"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "remote",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilderX/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), S = p('[{"provider":"aliyun","spaceName":"show","spaceId":"mp-fadb7861-380a-4b76-8688-265f035a23ba","clientSecret":"2UYcDwxRd4E0Ly2MfNKVXQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let I = "";
try {
  I = "__UNI__0707E1D";
} catch (e2) {
...
const Gn = !!pagesJson.uniIdRouter;
const { loginPage: Vn, routerNeedLogin: Yn, resToLogin: Qn, needLoginPage: Xn, notNeedLoginPage: Zn, loginPageInTabBar: es } = function({ pages: e2 = [], subPackages: n2 = [], uniIdRouter: s2 = {}, tabBar: r2 = {} } = pagesJson) {
