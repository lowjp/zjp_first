...
const uniIdCo = common_vendor.As.importObject("uni-id-co", { customUI: true });
const _sfc_main = {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("captcha", "1fbfa06e-10,1fbfa06e-9"),
    v: common_vendor.o(($event) => $data.formData.captcha = $event),
    w: common_vendor.p({
      scene: "register",
      modelValue: $data.formData.captcha
    }),
    x: common_vendor.sr("agreements", "1fbfa06e-11,1fbfa06e-0"),
    y: common_vendor.p({
      scope: "register"
    }),
    ...
    C: common_vendor.sr("form", "1fbfa06e-0"),
    D: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/HbuilderProjects/cloud20221217/uni_modules/uni-id-pages/pages/register/register-admin.vue"]]);
