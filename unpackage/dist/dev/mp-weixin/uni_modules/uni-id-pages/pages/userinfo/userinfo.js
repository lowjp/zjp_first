...
const _sfc_main = {
  ...
  methods: {
    ...
    async bindThirdAccount(provider) {
      const uniIdCo2 = common_vendor.As.importObject("uni-id-co");
      const bindField = {
        weixin: "wx_openid",
        alipay: "ali_openid",
        apple: "apple_openid",
      ...
      if (this.userInfo[bindField]) {
        ...
        common_vendor.index.login({
          ...
          onlyAuthorize: true,
          success: async (e) => {
            const res = await uniIdCo2["bind" + provider]({ code: e.code });
            if (res.errCode) {
...
const _easycom_uni_id_pages_avatar = () => "../../components/uni-id-pages-avatar/uni-id-pages-avatar2.js";
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0be2f605"], ["__file", "D:/HbuilderProjects/cloud20221217/uni_modules/uni-id-pages/pages/userinfo/userinfo.vue"]]);
